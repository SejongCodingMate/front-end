...
export default function CodeInputOBox() {
                ...
                <Container maxWidth="xl" >
                    <Grid container justifyContent="center" alignItems="center" >
                        <div style={{ flex: 1, padding: '16px' }}>
                            ...
                            <Grid justifyContent="space-between" style={{ backgroundColor: 'white' }}>
                               
                                <Grid container alignItems="center" >
                                    
                                    <Grid item xs={1} style={{marginLeft: '10px', marginTop:'15px', marginBottom:'15px', marginRight:'10px'}}>
                                        <Typography variant="h5" style={{color:'blue'}}> 입력{'>'} </Typography>
                                    </Grid>
